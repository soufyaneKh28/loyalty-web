    ...
    <main dir="rtl" className={` ${cairo.className}`}>
      ...
      <section className=" py-10">
        <div className="container flex flex-col items-center justify-center ">
          ...
          <p className="text-center max-w-[550px]">
            تأسست شركتنا عام 2013، وهي متخصصة في العلامات التجارية والتسويق
            ...
            فروع في دبي والإمارات العربية المتحدة والولايات المتحدة الأمريكية.
          </p>
        </div>
        <Statis object={data} />
      </section>
      ...
      <section className="py-10">
        <div className="container flex flex-col items-center justify-center my-10">
          <div className=" flex flex-col items-center">
            <div className="flex items-center mb-[-5px]">
              <div className="w-[60px] h-[2px] bg-secondary mr-1"></div>
              <h5 className=" text-secondary ">شركاؤنا</h5>
            </div>
          ...
          <p className="text-center max-w-[550px] mt-3">
            منذ بداية رحلتنا، ساعدتنا هذه الشركات في تمهيد طريق النجاح. من خلال
            العمل جنبًا إلى جنب لفترة كافية، أصبحنا شركاء ونذهب إلى المصدر
            للحصول على خدماتهم.
          </p>
        </div>
        <IconsSlider />
